...
// @Router /user/ [post]
// curl --location --request POST 'localhost:8080/user' --form 'Name'='' --form 'Password'='' --form 'Grade'=''
...
// @Failure 400 object model.Resp failed
// @Router /user/ [get]
// curl --location --request GET 'localhost:8080/user?ids=1&ids=2&ids=3&limit=3&offset=1'
...
// @Failure 400 object model.Resp failed
// @Router /user/ [put]
// curl --location --request PUT 'localhost:8080/user' --form 'id=''' --form 'Name'='' --form 'Password'='' --form 'Grade'=''
